function [A,MTTF,MTBF] = evaluate_RR(nm,n,lambdaB,lambdaR,lambdaI,lambdaU,lambdaD,muB,muR,muU)

%% model definition
[nstates, Qav, Qre, pi0, av_indx, sys_failure_indx] = CTMC_RR(nm,n,lambdaB,lambdaR,lambdaI,lambdaU,lambdaD,muB,muR,muU);  
