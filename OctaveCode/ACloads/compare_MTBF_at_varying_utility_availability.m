...
[A_SR(i),MTTF_SR,MTBF_SR(i)] = evaluate_SR(n,lambdaB_SR,lambdaR_SR,lambdaI_SR,lambdaU,lambdaD,muB_SR,muR_SR,muU);
[A_MR(i),MTTF_MR,MTBF_MR(i)] = evaluate_MR(nm,n,lambdaB_MR,lambdaR_MR,lambdaI_MR,lambdaU,lambdaD,muB_MR,muR_MR,muU);
[A_IR(i),MTTF_IR,MTBF_IR(i)] = evaluate_IR(nm,n,lambdaB_IR,lambdaR_IR,lambdaI_IR,lambdaU,lambdaD,muB_IR,muR_IR,muU);
[A_CR(i),MTTF_CR,MTBF_CR(i)] = evaluate_CR(nm,n,lambdaB_CR,lambdaR_CR,lambdaI_CR,lambdaU,lambdaD,muB_CR,muR_CR,muU);
  %
...
csvwrite('results-AC-r17-muU2-lambdaD0.125-varying-availability.csv', [A_U A_SR MTBF_SR A_MR MTBF_MR A_IR MTBF_IR A_CR MTBF_CR A_CR MTBF_CR]);
