function [A, MTTF, MTBF] = evaluate_SR(n,lambdaB,lambdaR,lambdaI,lambdaU,lambdaD,muB,muR,muU)

%% model definition
% notice: here last state is the system failed state
[Qre,Qav,pi0,av_indx] = CTMC_SR(n,lambdaB,lambdaR,lambdaI,lambdaU,lambdaD,muB,muR,muU);
