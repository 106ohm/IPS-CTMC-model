function [nstates, Qav, Qre, pi0, av_indx, sys_failure_indx] = CTMC_IR(nm,n,lambdaB,lambdaR,lambdaI,lambdaU,lambdaD,muB,muR,muU)
...
UOK_Rre = diag((lambdaR+lambdaB+lambdaI)*[nm:-1:n],1);
...
UKO_Rre = diag((lambdaB+lambdaI)*[nm:-1:n]+n*lambdaD*ones(1,nm-n+1),1);
