function [nstates, Qav, Qre, pi0, av_indx, sys_failure_indx] = CTMC_MR(nm,n,lambdaB,lambdaR,lambdaI,lambdaU,lambdaD,muB,muR,muU)
...
UOK_Rre = diag((lambdaR+lambdaI)*[nm:-1:n],1)+lambdaB*[zeros(nm-n+2,nm-n+1) [ones(nm-n+1,1); 0]];
...
UKO_Rre = (n*lambdaD+lambdaB+lambdaI)*[zeros(nm-n+2,nm-n+1) [ones(nm-n+1,1); 0]];
