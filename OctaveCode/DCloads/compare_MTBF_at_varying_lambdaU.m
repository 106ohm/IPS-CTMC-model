...
for i = 1 : numberOfEvaluations
  ...
  [A_MR_min(i),MTTF_MR_min,MTBF_MR_min(i)] = evaluate_MR(nm,n,lambdaB_MR,lambdaR_MR,lambdaU(i),lambdaD_MR_min,muB_MR,muR_MR,muU_min);
  ...
  [A_MR_max(i),MTTF_MR_max,MTBF_MR_max(i)] = evaluate_MR(nm,n,lambdaB_MR,lambdaR_MR,lambdaU(i),lambdaD_MR_max,muB_MR,muR_MR,muU_max);
...
csvwrite('results-r17-min-max-muU-varyingLambdaU.csv', [A_U_min A_SR_min MTBF_SR_min A_MR_min MTBF_MR_min A_IR_min MTBF_IR_min A_CR_min MTBF_CR_min A_U_max A_SR_max MTBF_SR_max A_MR_max MTBF_MR_max A_IR_max MTBF_IR_max A_CR_max MTBF_CR_max lambdaU]);
