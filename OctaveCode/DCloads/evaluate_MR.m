function [A,MTTF,MTBF] = evaluate_MR(nm,n,lambdaB,lambdaR,lambdaU,lambdaD,muB,muR,muU)

%% model definition
[nstates, Qav, Qre, pi0, av_indx, sys_failure_indx] = CTMC_MR(nm,n,lambdaB,lambdaR,lambdaU,lambdaD,muB,muR,muU);  
